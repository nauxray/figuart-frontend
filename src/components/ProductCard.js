...
const ProductCard = ({ product }) => {
  return (
    <Link
      ...
      className="bg-black border-2 flex flex-col border-lilac rounded-md overflow-hidden max-h-[20rem] xl:w-[18rem] md:w-[15rem] w-5/6 max-md:mx-auto cursor-pointer hover:scale-105 transition-all duration-300"
    >
